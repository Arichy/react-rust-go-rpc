...
function RustGRPC() {
  ...
  return (
    <div className="w-full px-2 sm:px-4 lg:px-6">
      <h1 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8 bg-gradient-to-r from-indigo-300 to-indigo-500 bg-clip-text text-transparent">
        Person CRUD with Rust gRPC
      </h1>
