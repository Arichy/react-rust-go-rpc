        ...
        <div className="rounded-lg shadow-md overflow-hidden">
          <table className="w-full border-collapse table-auto">
            <thead className="bg-primary text-white">
              <tr>
                <th className="px-1 py-2 text-left text-xs tracking-wider font-medium w-0 overflow-hidden lg:table-cell text-black">
                  ID
                </th>
            ...
            <tbody>
              {people.map(person => {
                return (
                  ...
                  >
                    <td className="px-1 py-2 text-left hidden lg:table-cell text-xs wrap-break-word">{person.id}</td>
